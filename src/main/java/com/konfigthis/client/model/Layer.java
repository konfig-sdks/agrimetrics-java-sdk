...
import com.konfigthis.client.model.LayerLinks;
...
public class Layer {
  ...
  **/
  ...
  public Layer links(LayerLinks links) {
  ...
  **/
  ...
  public LayerLinks getLinks() {
    return links;
  }


  public void setLinks(LayerLinks links) {
   ...
   * @return the Layer instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    Layer layer = (Layer) o;
    return Objects.equals(this.description, layer.description) &&
        Objects.equals(this.layerId, layer.layerId) &&
        Objects.equals(this.links, layer.links)&&
        Objects.equals(this.additionalProperties, layer.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, layerId, links, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Layer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Layer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : Layer.openapiRequiredFields) {
      ...
      LayerLinks.validateJsonObject(jsonObj.getAsJsonObject("links"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Layer>() {
           ...
           public Layer read(JsonReader in) throws IOException {
             ...
             Layer instance = thisAdapter.fromJsonTree(jsonObj);
