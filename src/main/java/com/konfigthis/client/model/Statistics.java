...
public class Statistics {
  ...
  public Statistics bands(List<Band> bands) {
  ...
  public Statistics addBandsItem(Band bandsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bands, statistics.bands)&&
        Objects.equals(this.additionalProperties, statistics.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bands, additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("bands");
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      // validate the required field `bands` (array)
      for (int i = 0; i < jsonArraybands.size(); i++) {
        Band.validateJsonObject(jsonArraybands.get(i).getAsJsonObject());
      };
  }
