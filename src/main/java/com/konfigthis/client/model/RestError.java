...
public class RestError {
  ...
  **/
   ...
   * @return the RestError instance itself
   */
  public RestError putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, restError.message)&&
        Objects.equals(this.additionalProperties, restError.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RestError>() {
           ...
           public RestError read(JsonReader in) throws IOException {
             ...
             RestError instance = thisAdapter.fromJsonTree(jsonObj);
