...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api-test.agrimetrics.co.uk/catalog";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("sec0", new ApiKeyAuth("header", "ocp-apim-subscription-key"));
        authentications.put("xUserHeader", new ApiKeyAuth("header", "x-user-id"));
        ...
        if (configuration != null) {
            ...
            if (configuration.xUserHeader != null) {
                this.setXUserHeader(configuration.xUserHeader);
            }
    ...
    public String getApiKeyHeader() {
        return ((ApiKeyAuth) this.getAuthentication("apiKeyHeader")).getApiKey();
    }

    public void setApiKeyHeader(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("apiKeyHeader")).setApiKey(apiKey);
    }

    public void setApiKeyHeaderPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("apiKeyHeader")).setApiKeyPrefix(prefix);
    }
    public String getApiKeyQuery() {
        return ((ApiKeyAuth) this.getAuthentication("apiKeyQuery")).getApiKey();
    }

    public void setApiKeyQuery(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("apiKeyQuery")).setApiKey(apiKey);
    }

    public void setApiKeyQueryPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("apiKeyQuery")).setApiKeyPrefix(prefix);
    }
    ...
    public String getXUserHeader() {
        return ((ApiKeyAuth) this.getAuthentication("xUserHeader")).getApiKey();
    }

    public void setXUserHeader(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("xUserHeader")).setApiKey(apiKey);
    }

    public void setXUserHeaderPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("xUserHeader")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api-test.agrimetrics.co.uk/catalog)
