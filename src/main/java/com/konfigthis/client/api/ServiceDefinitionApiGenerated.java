...
public class ServiceDefinitionApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ServiceDefinitionApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public ServiceDefinitionApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
